...
- 다시 누를 때까지 문장을 누적하는 음성 질문 입력과 생성 답변 읽어주기
...
Mock 서버는 로그인 사용자 유형과 현재 질문에 맞는 fixture 카드를 선별하고, 같은 proposal의 질문과 실제 승인 ID를 답변에 반영합니다. 계약 타입과 원본 fixture는 변경하지 않습니다.
